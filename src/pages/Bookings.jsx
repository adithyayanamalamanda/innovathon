    ...
    const handleSubmit = async () => {
        ...
        try {
            await base44.entities.Review.create({
                ...
                rating,
                comment,
                reviewer_name: booking.farmer_name || 'Anonymous'
            });
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }}
                ...
                {done ? (
                    <div className="text-center py-8">
                        <div className="w-20 h-20 bg-amber-100 text-amber-500 rounded-full flex items-center justify-center mx-auto mb-6 animate-bounce">
                    ...
                    <>
                        <h3 className="text-2xl font-black text-slate-900 mb-1">Leave a Review</h3>
                        ...
                        <textarea value={comment} onChange={e => setComment(e.target.value)}
                            ...
                            className="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl outline-none focus:ring-2 focus:ring-primary/20 font-medium text-slate-700 h-28 resize-none mb-6" />
