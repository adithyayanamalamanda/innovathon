                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-4xl font-bold text-slate-900 mb-6 leading-tight">
                                ...
                                <span className="text-primary">{t('home.realTimeTitle2')}</span>
                            </h2>
                        ...
                        <div className="relative">
                            ...
                            >
                                <div className="rounded-3xl overflow-hidden shadow-2xl bg-white p-8 border border-slate-100">
                                    ...
                                    {/* Error State */}
                                    {weatherError && (
                                        <div className="bg-red-50 border border-red-100 text-red-600 text-sm rounded-2xl p-4 mb-6">
                                            {weatherError}
                                        </div>
                                    )}
                                    ...
                                    {!locationRequested && !weatherLoading && (
                                        <div className="bg-slate-50 rounded-2xl p-6 mb-6 border border-slate-100 text-center">
                                            <LocateFixed className="w-8 h-8 text-primary mx-auto mb-3" />
                ...
                <div className="container mx-auto">
                    <div className="flex justify-between items-end mb-16">
                        <div>
                            ...
                            <h2 className="text-4xl font-bold text-slate-900">{t('home.onePlatform')}</h2>
                        </div>
