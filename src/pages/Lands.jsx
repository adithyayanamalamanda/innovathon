    ...
    return (
        <div className="container mx-auto px-4 pb-20">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                <div>
                    <h1 className="text-4xl font-bold text-slate-900 tracking-tight mb-2">{t('lands.title')}</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <AnimatePresence>
                        {filteredLands.map((land, index) => (
                            ...
                            >
                                <LandCard land={land} onClick={() => openLandDetails(land)} t={t} />
                            </motion.div>
                        ))}
                    </AnimatePresence>
                </div>
            ...
            {!loading && filteredLands.length === 0 && (
                <div className="text-center py-20">
                    ...
                    <h3 className="text-xl font-bold text-slate-800 mb-2">{t('lands.noLandsFound')}</h3>
                    <p className="text-slate-500">{t('lands.noLandsHint')}</p>
                </div>
            )}
