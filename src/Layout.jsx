            ...
            <nav className={cn(
                ...
                <div className="container mx-auto px-4 md:px-6">
                    <div className="flex items-center justify-between">
                        ...
                        {/* Desktop Nav */}
                        <div className="hidden lg:flex items-center gap-0.5 p-1.5 glass rounded-2xl mx-4">
                            {navLinks.map((link) => (
                                <NavLink
                                    key={link.path}
                                    to={link.path}
                                    className={({ isActive }) => cn(
                                        "flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all duration-300 relative group overflow-hidden",
                                        isActive
                                ...
                                >
                                    {({ isActive }) => (
                                        <>
                                            ...
                                            {link.name}
                                            {isActive && (
                                                <span className="absolute bottom-0.5 left-1/2 -translate-x-1/2 w-6 h-0.5 rounded-full bg-primary animate-scale-in" />
                                            )}
                                        </>
                                    )}
                                </NavLink>
